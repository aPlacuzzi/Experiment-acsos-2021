...
public abstract class AbstractNode<T> implements Node<T> {
    ...
    private static final ConcurrentMap<Environment<?, ?>, AtomicInteger> IDGENERATOR =
    ...
    @Override
    public final void removeReaction(final Reaction<T> reaction) {
        reactions.remove(reaction);
        ((Engine<T, ?>) environment.getSimulation()).reactionRemoved(reaction);
    }
